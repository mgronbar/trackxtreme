...
import com.track.trackxtreme.rest.data.Book;
...
public class BookEditActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// long index =
		// savedInstanceState.getLong(LibraryApplication.KEY_BOOK_ISBN);
	...
	protected void onResume() {
		...
		if (currBook == null) {
			...
			// String isbn = extras != null ?
			// extras.getString(LibraryApplication.KEY_BOOK_ISBN) : null;
	...
	private void registerButtonListeners() {
		...
		saveButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View view) {
				saveState();
				setResult(RESULT_OK);
				// Toast.makeText(BookEditActivity.this,
				// getString(R.string.book_saved_message), Toast.LENGTH_SHORT)
				// .show();
				finish();
			}
